        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoatypeId = table.Column<int>(type: "int", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CoaTranType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Debit = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Credit = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Transable = table.Column<bool>(type: "bit", nullable: true),
                    LevelNo = table.Column<int>(type: "int", nullable: true),
                    OpeningBlnc = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    OpeningBlncDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CoatypeName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Coatypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErrorLogShortDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ErrorLogLongDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ErrorFrom = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesignNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Ppq = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PurchasePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    WholeSalePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    SalePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ColorId = table.Column<int>(type: "int", nullable: true),
                    PurchaseCoaid = table.Column<int>(type: "int", nullable: true),
                    SaleCoaid = table.Column<int>(type: "int", nullable: true),
                    ReturnCoaid = table.Column<int>(type: "int", nullable: true),
                    DiscCoaid = table.Column<int>(type: "int", nullable: true),
                    ExpenseCoaid = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RightEmail = table.Column<bool>(type: "bit", nullable: false),
                    RightNotification = table.Column<bool>(type: "bit", nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyId = table.Column<int>(type: "int", nullable: true),
                    isTenantAdmin = table.Column<bool>(type: "bit", nullable: true),
