...
{
    [Authorize]
    public class SuperAdminTemplateBuilderViewComponent : ViewComponent
    {
        private readonly IModuleRepository _ModuleRepo;
        private readonly IProjectPermissionRepository _ProjectPermissionRepository;

        public SuperAdminTemplateBuilderViewComponent(IModuleRepository ModuleRepo, IProjectPermissionRepository projectPermissionRepository)
        {
